...
/**
 * Console command to install OrderPay.
 * This sets up OrderPay for the first time. It will prompt the user for several
...
class IgniterInstall extends Command
{
     ...
     */
    protected $description = 'Set up OrderPay for the first time.';
