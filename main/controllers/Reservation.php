...
class Reservation extends Main_Controller {
	...
	public function index() {
		...
		$data['text_login_register']		= ($this->customer->isLogged()) ? sprintf($this->lang->line('text_logout'), $this->customer->getName(), site_url('account/logout'.$prepend)) : sprintf($this->lang->line('text_login'), site_url('login'.$prepend));
	...
	public function success() {
	    return 'reservation has been placed';
		$this->template->setBreadcrumb('<i class="fa fa-home"></i>', '/');
		$this->template->setBreadcrumb($this->lang->line('text_heading'), 'reservation');
