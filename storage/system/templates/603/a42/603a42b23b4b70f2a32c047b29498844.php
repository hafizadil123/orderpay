<?php foreach ($locationsList as $location) { ?>
    ...
    <a
        ...
        href="<?= page_url('/'.$location->permalink_slug.'/menus'); ?>"
    >
        ...
        <div class="row boxes">
            ...
            <?php } ?>
            <div class="col-12 col-sm-5" style="  white-space: nowrap; 
  width: 50px; 
  overflow: hidden;
  text-overflow: ellipsis;">
                <dl>
                    ...
                    <?php } ?>
                    <dd>
                        <span style="word-wrap: break-word !important;" class="text-muted text-truncate"><?= format_address($location->getAddress()); ?></span>
                    </dd>
                    <?php if ($distance) { ?>
                        <dd>
