    ...
    public function onComplete()
    {
        ...
        try {
            ...
            if (!$redirect = input('redirect'))
                ...
                $data['location'] = Location::getById($data['location'])->attributes['permalink_slug'];
            return Redirect::to($this->controller->pageUrl('/'.$data['location'].'/menus', ['hash' => $reservation->hash]));
        }
