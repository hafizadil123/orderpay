<form role="form" class="form-horizontal" accept-charset="utf-8" method="POST" action="<?php echo current_url(); ?>" >
	<div class="form-group">
		...
		<div class="col-sm-9">
			<input type="text" required  name="database" id="input-db-name" class="form-control" value="<?php echo $database; ?>" />
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			<input type="text" required  name="hostname" id="input-db-host" class="form-control" value="<?php echo $hostname; ?>" />
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			<input type="text" required  name="username" id="input-db-user" class="form-control" value="<?php echo $username; ?>" />
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			<input type="text" required  name="dbprefix" id="input-db-prefix" class="form-control" value="<?php echo $dbprefix; ?>" />
